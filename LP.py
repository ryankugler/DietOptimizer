...
# Fruits and Vegetables to Other Food Groups Ratio (2:1)
...
# Grains to Proteins Ratio (1:1)
m.addConstr(1 * quicksum(x[i] for i in grains_indices) == quicksum(x[i] for i in proteins_indices), "GrainsToProteinsRatio")

# Maximum 1 Serving of Junk Food
m.addConstr(quicksum(x[i] for i in junk_indices) <= 1, "MaxJunkFood")
